...
function StatisticsModalComponent(props: StateToProps & DispatchToProps): JSX.Element {
    ...
    const makeShapesTracksTitle = (title: string): JSX.Element => (
        <CVATTooltip title={is2D ? '形状 / 跟踪' : '形状'}>
    ...
    const columns = [
        ...
        {
            title: makeShapesTracksTitle('多段线'),
            dataIndex: 'polyline',
            key: 'polyline',
            width: 100,
        },
        {
            title: makeShapesTracksTitle('点状'),
            dataIndex: 'points',
            key: 'points',
            width: 100,
        },
    ...
    return (
        <Modal {...baseProps}>
            <div className='cvat-job-info-modal-window'>
                <Row justify='start'>
                    <Col>
                        <Text className='cvat-text'>信息概述</Text>
                    </Col>
                </Row>
                <Row justify='start'>
                    <Col span={4}>
                ...
                <Row justify='space-around' className='cvat-job-info-statistics'>
                    <Col span={24}>
                        <Text className='cvat-text'>标注/注释统计数据</Text>
                        <Table
